    ...
    1: [function (a, b, c) {
        !function (a) {
            ...
            b.utils = c, a.Autocomplete = b, b.formatResult = function (a, b) {
                ...
                killerFn: null, initialize: function () {
                    ...
                    var b, c, d = this, e = d.options, f = e.formatResult, g = d.getQuery(d.currentValue), h = d.classes.suggestion, i = d.classes.selected, j = a(d.suggestionsContainer), k = e.beforeRender, l = "";
                ...
                containerClass: "sui-ab-menu sui-suggestion-container",
                tabDisabled: !1,
                dataType: "text",
                currentRequest: null,
        ...
        !function (a) {
            ...
            a.fn.carousel = function (c) {
                return this.each(function () {
                    var d = a(this), e = d.data("carousel"), f = a.extend({}, a.fn.carousel.defaults, d.data(), "object" == typeof c && c), g = "string" == typeof c ? c : f.slide;
        ...
        !function (a, b) {
            ...
            j.prototype = {
                constructor: j, _process_options: function (b) {
                    ...
                    this.picker.find(".datepicker-days thead th.datepicker-switch").text(f + "年 " + o[this.o.language].months[g]), this.picker.find("tfoot th.today").text(l).toggle(this.o.todayBtn !== !1), this.picker.find("tfoot th.clear").text(m).toggle(this.o.clearBtn !== !1), this.updateNavArrows(), this.fillMonths();
                    ...
                    for (var s, t = []; n.valueOf() < r;) {
                        ...
                        s = a.unique(s);
                        var z, A = new Date;
                        z = this.o.todayHighlight && n.getUTCFullYear() === A.getFullYear() && n.getUTCMonth() === A.getMonth() && n.getUTCDate() === A.getDate() ? "今日" : n.getUTCDate(), t.push('<td class="' + s.join(" ") + '"' + (d ? ' title="' + d + '"' : "") + 'data-day="' + n.getUTCDate() + '">' + z + "</td>"), n.getUTCDay() === this.o.weekEnd && t.push("</tr>"), n.setUTCDate(n.getUTCDate() + 1)
                    }
        ...
        !function (a) {
            "use strict";
            var b = "[data-toggle=ab]", c = ".sui-ab, .sui-dropup", d = function () {
                a(".sui-ab.open, .sui-dropup.open, .sui-btn-group.open").each(function () {
                    a(this).removeClass("open")
                })
            }, e = function (a) {
                var b = a.parent();
                return b.hasClass("ab-inner") ? b.parent() : b
            }, f = function () {
                d();
                var b = a(this), c = e(b);
                ...
                var c = a(this), d = c.parent(), e = c.parents(".sui-ab, .sui-dropup"), f = e.find("[role='menu']");
            ...
            }), a(document).on("click", "[data-toggle='ab']", h), a(document).on("click", function () {
                var b = a(this);
                b.is(c) || b.parents(c)[0] || d()
            }), a(document).on("click", ".select .sui-ab-menu a", i), a.fn.ab = function (b) {
                return this.each(function () {
                    if (a(this).attr("data-toggle", "ab"), "string" == typeof b)switch (b) {
                        case"show":
                            f.call(this);
                            break;
                        case"hide":
        ...
        !function (a) {
            ...
            a.extend({
                filesize: function (a, b) {
                    var c, d = "", e = b || {}, f = Number(a), g = ["B", "kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], h = void 0 !== e.round ? e.round : 2;
        ...
        !function (a) {
            ...
            function l(a) {
                ...
                q(a.element);
                if (null !== c) {
                    var d = c.querySelector(".introjs-helperNumberLayer"), e = c.querySelector(".introjs-tooltiptext"), f = c.querySelector(".introjs-arrow"), l = c.querySelector(".introjs-tooltip"), p = c.querySelector(".introjs-skipbutton"), r = c.querySelector(".introjs-prevbutton"), s = c.querySelector(".introjs-nextbutton");
                    ...
                    var x = document.createElement("div"), y = document.createElement("div"), z = document.createElement("div"), A = document.createElement("div"), B = document.createElement("div"), C = document.createElement("div");
                ...
                if (!o(a.element) && this._options.scrollToElement === !0) {
                    var N = a.element.getBoundingClientRect(), O = n().height, P = N.bottom - (N.bottom - N.top), Q = N.bottom - O;
        ...
        !function (a) {
            ...
            b.prototype = {
                _draw: function () {
                    ...
                    var a = this.hookNode.children(".sui-pagination"), b = '<ul><li class="prev' + (this.currentPage - 1 <= 0 ? " disabled" : " ") + '"><a href="#" data="' + (this.currentPage - 1) + '">«上一页</a></li>';
                    ...
                    b += '<li class="next' + (this.currentPage + 1 > this.pages ? " disabled" : " ") + '"><a href="#" data="' + (this.currentPage + 1) + '">下一页»</a></li></ul>', this.showCtrl && (b += this._drawCtrl()), a.html(b)
                }, _drawCtrl: function () {
        ...
        a("./transition"), a("./msgs"), a("./filesize"), a("./button"), a("./ab"), a("./modal"), a("./tooltip"), a("./tab"), a("./pagination"), a("./validate"), a("./validate-rules"), a("./tree"), a("./datepicker"), a("./timepicker"), a("./checkbox"), a("./autocomplete"), a("./intro"), a("./carousel"), a("./template")
    }, {
        "./autocomplete": 1,
        "./button": 2,
        "./carousel": 3,
        ...
        !function (a) {
            ...
            b.prototype = {
                constructor: b, show: function () {
                    var b, c, d, e = this.element, f = e.closest("ul:not(.ab-menu)"), g = e.attr("data-target");
                    ...
                    function e() {
                        f.removeClass("active").find("> .ab-menu > .active").removeClass("active"), b.addClass("active"), g ? (b[0].offsetWidth, b.addClass("in")) : b.removeClass("fade"), b.parent(".ab-menu") && b.closest("li.ab").addClass("active"), d && d()
                    }
        ...
        !function (a) {
            ...
            a.template = function (b, c, f) {
                ...
                var i = RegExp([(c.escape || e).source, (c.interpolate || e).source, (c.evaluate || e).source].join("|") + "|$", "g"), j = 0, k = "__p+='";
        ...
        !function (a) {
            ...
            b.prototype = {
                _defaultCfg: {
                    ...
                    this.element = a(b), this.isInline = !1, this.isInDatepicker = !1, this.isInput = this.element.is("input"), this.component = this.element.is(".date") ? this.element.find(".add-on, .input-group-addon, .sui-btn") : !1, this.hasInput = this.component && this.element.find("input").length, this.component && 0 === this.component.length && (this.component = !1), this.picker = a('<div class="timepicker"></div>'), this.o = this.config = a.extend(this._defaultCfg, c), this._buildEvents(), this._attachEvents(), this.isInDatepicker ? this.picker.addClass("timepicker-in-datepicker").appendTo(this.element) : this.isInline ? (this.picker.addClass("timepicker-inline").appendTo(this.element), this._show()) : this.picker.addClass("timepicker-ab ab-menu")
                }, destory: function () {
                    ...
                    if (!this.isInline && !this.isInDatepicker) {
                        var b = this.picker.outerWidth(), c = this.picker.outerHeight(), d = 10, e = a(window), f = e.width(), g = e.height(), h = e.scrollTop(), i = parseInt(this.element.parents().filter(function () {
                                return "auto" !== a(this).css("z-index")
                            }).first().css("z-index")) + 10, j = this.component ? this.component.parent().offset() : this.element.offset(), k = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1), l = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), m = j.left, n = j.top;
                    ...
                    this.picker.on("click", ".J_up", function (c) {
                        ...
                        var d = c.currentTarget, e = a(d).parent().parent().parent(), f = e.attr("data-role"), g = d.innerHTML, h = b[f + "Attr"], i = parseInt(g - h.current, 10);
        ...
        !function (a) {
            ...
            a.fn.extend({
                tree: function () {
                    ...
                    return this.each(function () {
                        var f = a(this), g = f.data("tree"), h = a.extend({}, a.fn.tree.defaults, f.data(), "object" == typeof e && e);
        ...
        !function (a) {
            ...
            var c = function () {
                ...
                var d = c[0].tagName.toUpperCase(), e = (c.attr("type") || "text").toUpperCase(), f = c.attr("name"), g = c.parents("form");
                switch (d) {
                    case"INPUT":
                        switch (e) {
                            case"CHECKBOX":
