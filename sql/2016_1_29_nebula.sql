...
-- ----------------------------
--  Table structure for `nebula_publish_slb`
-- ----------------------------
DROP TABLE IF EXISTS `nebula_publish_slb`;
CREATE TABLE `nebula_publish_slb` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `publish_event_id` int(11) DEFAULT NULL COMMENT '发布事件id',
  `publish_module_id` int(11) DEFAULT NULL COMMENT '发布模块id',
  `load_balancer_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '负载均衡id	',
  `load_balancer_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '负载均衡名称',
  `load_balancer_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '负载均衡地址',
  `load_balancer_status` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '负载均衡状态	',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_module_id_ip` (`publish_module_id`) USING BTREE,
  UNIQUE KEY `unique_load_balancer_id_ip` (`load_balancer_id`) USING BTREE
