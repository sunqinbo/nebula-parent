...
-- ----------------------------
BEGIN;
INSERT INTO `acl_permission` VALUES ('1', 'user', '用户管理', '用户管理', 'user:*', 'menu', 'user/list.htm', '0', null, '1'), ('2', 'user:add', '用户添加', '用户添加', 'user:add', 'button', '', '1', null, '1'), ('4', 'user:update', '用户更新', '用户更新', 'user:update', 'button', '', '1', null, '1'), ('5', 'user:delete', '用户删除', '用户删除', 'user:delete', 'button', '', '1', null, '1'), ('6', 'user:view', '用户查询', '用户查询', 'user:view', 'button', '', '1', null, '1'), ('7', 'permission', '资源管理', '资源管理', 'permission:*', 'menu', 'permission/list.htm', '0', null, '1'), ('8', 'permission:add', '资源添加', '资源添加', 'permission:add', 'button', '', '7', null, '1'), ('9', 'permission:update', '资源更新', '资源更新', 'permission:update', 'button', '', '7', null, '1'), ('10', 'permission:delete', '资源删除', '资源删除', 'permission:delete', 'button', '', '7', null, '1'), ('11', 'permission:view', '资源查询', '资源查询', 'permission:view', 'button', '', '7', null, '1'), ('12', 'role', '角色管理', '角色管理', 'role:*', 'menu', 'role/list.htm', '0', null, '1'), ('13', 'role:add', '角色添加', '角色添加', 'role:add', 'button', '', '12', null, '1'), ('14', 'role:delete', '角色删除', '角色删除', 'role:delete', 'button', '', '12', null, '1'), ('15', 'role:update', '角色更新', '角色更新', 'role:update', 'button', '', '12', null, '1'), ('16', 'role:view', '角色查询', '角色查询', 'role:view', 'button', '', '12', null, '1'), ('21', 'publishapply', '发布申请', '发布申请', 'publishapply:*', 'menu', '/publish/event.htm', '0', null, '1'), ('22', 'publishevent', '发布操作', '发布操作', 'publishevent:*', 'menu', '/publish/list.htm', '0', null, '1'), ('24', 'publishapply:commit', '发布提交', '发布提交', 'publishapply:commit', 'button', '', '21', null, '1'), ('25', 'publishevent:view', '发布查看', '发布查看', 'publishevent:view', 'button', '', '22', null, '1'), ('26', 'publishevnt:prePublishMaster', '准备发布', '准备发布', 'publishevnt:prePublishMaster', 'button', '', '22', null, '1'), ('27', 'publishevnt:prePublishMinion', '启动预发布', '启动预发布', 'publishevnt:prePublishMinion', 'button', '', '22', null, '1'), ('28', 'publishevnt:publishReal', '启动正式发布', '启动正式发布', 'publishevnt:publishReal', 'button', '', '22', null, '1'), ('29', 'publishevnt:publishContinue', '发布重试', '发布重试', 'publishevnt:publishContinue', 'button', '', '22', null, '1'), ('30', 'publishevnt:publishSuccessEnd', '确认发布成功', '确认发布成功', 'publishevnt:publishSuccessEnd', 'button', '', '22', null, '1'), ('31', 'publishevnt:publishFailEnd', '回滚', '回滚', 'publishevnt:publishFailEnd', 'button', '', '22', null, '1'), ('32', 'publishevnt:retryPublishRollback', '重新发布', '重新发布', 'publishevnt:retryPublishRollback', 'button', '', '22', null, '1'), ('33', 'publishevnt:updateEtcEnd', 'Etc编辑完成', 'Etc编辑完成', 'publishevnt:updateEtcEnd', 'button', '', '22', null, '1'), ('34', 'publishevnt:addnextpublish', '发布升级', '发布升级', 'publishevnt:addnextpublish', 'button', '', '22', null, '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `acl_role_permission` VALUES ('1', '1', '34'), ('2', '1', '33'), ('3', '1', '32'), ('4', '1', '31'), ('5', '1', '30'), ('6', '1', '29'), ('7', '1', '28'), ('8', '1', '27'), ('9', '1', '26'), ('10', '1', '25'), ('11', '1', '24'), ('12', '1', '16'), ('13', '1', '15'), ('14', '1', '14'), ('15', '1', '13'), ('16', '1', '11'), ('17', '1', '10'), ('18', '1', '9'), ('19', '1', '8'), ('20', '1', '6'), ('21', '1', '5'), ('22', '1', '4'), ('23', '1', '2'), ('24', '2', '24'), ('25', '3', '26'), ('26', '3', '25'), ('27', '3', '24'), ('28', '4', '25'), ('29', '5', '34'), ('30', '5', '33'), ('31', '5', '32'), ('32', '5', '31'), ('33', '5', '30'), ('34', '5', '29'), ('35', '5', '28'), ('36', '5', '27'), ('37', '5', '26'), ('38', '5', '25'), ('39', '5', '24'), ('40', '5', '16'), ('41', '5', '15'), ('42', '5', '14'), ('43', '5', '13'), ('44', '5', '11'), ('45', '5', '10'), ('46', '5', '9'), ('47', '5', '8'), ('48', '5', '6'), ('49', '5', '5'), ('50', '5', '4'), ('51', '5', '2');
COMMIT;
